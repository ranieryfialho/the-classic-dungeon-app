...
export function RoomLobby() {
  const { gameState, setGameState, startGameSelection } = useMultiplayerGame();
  ...
  return (
    <div className="min-h-screen w-full bg-dungeon-black bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-ancient-stone via-stone-charcoal to-dungeon-black p-4">
